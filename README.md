...
Note that the data is not included in the repository, and must thus be loaded using \texttt{src/grape_vine_classification/import_data.py} which downloads the data from kaggle into the data folder.
